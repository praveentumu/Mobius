...
using System.IO;
using System.Data;
using SAMLAssertion.DocQuery;
namespace SAMLAssertion
{
    public class SAMLAssertionForDocQuery
    {
        ...
        public AssertionType CreateAssertion(string strReciever, string strUserName, string strEntityId, DateTime dtmRuleStartDate, DateTime dtmRuleEndDate, string strHomeCommunityId,DataSet dsUserInfo, string PurposeOfUse, string PatientId)
        {
            ...
            objAssertionType.personName = new PersonNameType1();
            ...
            objAssertionType.secondWitnessName = new PersonNameType1();
            ...
            objAssertionType.witnessName = new PersonNameType1();
            ...
            objAssertionType.userInfo = new UserType1();
            objAssertionType.userInfo.personName=new PersonNameType1();
