<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterPatient.aspx.cs"
    Inherits="RegisterPatient" MasterPageFile="~/Unregistered.master" EnableEventValidation="false"
    Title="Register Patient" ValidateRequest="false" %>
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="2" style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <th align="left" colspan="2">
                                                <font color="red">*</font>
                                                <asp:Label ID="lblPassword" CssClass="text" runat="server" align="left" Text="User Password"></asp:Label>
                                            </th>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:TextBox Visible="true" Font-Size="9" ID="txtUserEmail" runat="server" CssClass="text"></asp:TextBox>
                                            </td>
                                            <td colspan="2">
                                                <asp:TextBox Font-Size="9" ID="txtPassword" Visible="true" TextMode="Password" runat="server"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                            <tr>
                                <td align="left" valign="top" colspan="1">
                                    ...
                                    <asp:Label ID="Label2" runat="server" align="left" CssClass="text" Text="Certificate Signing Request:"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="left" class="text" valign="top" style="width: 350px;">
                                    <asp:TextBox Width="450px" ID="txtCSR" ReadOnly="true" runat="server" ValidationGroup="ProviderGroup"
                                        Height="50px" TextMode="MultiLine"></asp:TextBox>
                                    <asp:Button Text="Generate CSR" ID="btnGenerateCSR" runat="server" CssClass="Button"
                                        ValidationGroup="ProviderGroup" OnClick="btnGenerateCSR_Click" />
                                </td>
                                <td class="text" valign="top" align="left" style="width: 250px;">
                ...
                <tr>
                    <td align="center" class="text" valign="bottom" style="width: 100%">
                        ...
                        <asp:Button ID="btnUpdate" OnClick="btnUpdate_Click" runat="server" CssClass="Button"
                            Text="Update" Style="margin-left: 14px" Width="50px" Visible="false" />
