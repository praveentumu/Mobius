...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript" src="Scripts/msPopup.js"></script>
    <style type="text/css">
        .style3
        {
    ...
    <script language="javascript" type="text/javascript">
        ...
        function disp_confirm() {
            ...
            var r = confirm("This action will deactivate all previous devices and activate this device only for account access. Do you want to continue?");
            if (r)
            { return true; }
            else { return false; }
        }
        ...
        <table width="97%" border="0" align="center" cellpadding="0" cellspacing="5" height="180px">
            ...
            <tr>
                <td align="center" style="height: 27px" class="style3" colspan="2">
                    <asp:Button ID="btnActivateUser" runat="server" CssClass="ButtonBG" Text="Activate"
                        OnClick="ActivateUser_Click" ValidationGroup="Import" />&nbsp;
