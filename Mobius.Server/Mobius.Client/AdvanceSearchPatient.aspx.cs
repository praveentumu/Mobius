...
public partial class SearchUser : BaseClass
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string[] splitStringOn = new string[1] { "\n" };
            ...
            if (!string.IsNullOrWhiteSpace(txtSuffix.Text))
                searchPatientRequest.Demographics.Suffix = txtSuffix.Text.Trim();
            if (!string.IsNullOrWhiteSpace(txtPrefix.Text))
                searchPatientRequest.Demographics.Prefix = txtPrefix.Text.Trim();
            ...
            searchPatientRequest.Demographics.MothersMaidenName = new MobiusServiceLibrary.Name();
            if (!string.IsNullOrWhiteSpace(txtMotherFamilyName.Text))
            {
                searchPatientRequest.Demographics.MothersMaidenName.FamilyName = txtMotherFamilyName.Text.Trim(); ;
            }

            if (!string.IsNullOrWhiteSpace(txtMotherMiddleName.Text))
            {
                searchPatientRequest.Demographics.MothersMaidenName.MiddleName = txtMotherMiddleName.Text.Trim();
            }

            if (!string.IsNullOrWhiteSpace(txtMotherGivenName.Text))
            {
                searchPatientRequest.Demographics.MothersMaidenName.GivenName = txtMotherGivenName.Text.Trim();
            }

            if (!string.IsNullOrWhiteSpace(txtMotherSuffix.Text))
            {
                searchPatientRequest.Demographics.MothersMaidenName.Suffix = txtMotherSuffix.Text.Trim();
            }

            if (!string.IsNullOrWhiteSpace(txtMotherPrefix.Text))
            {
                searchPatientRequest.Demographics.MothersMaidenName.Prefix = txtMotherPrefix.Text.Trim();
            }
            ...
            {
                searchPatientRequest.Demographics.MiddleName = txtMiddleName.Text.Trim();
            }

            if (!string.IsNullOrWhiteSpace(txtPhoneNumbers.Text))
            {
                searchPatientRequest.Demographics.ContractNumbers = new List<string>();
                searchPatientRequest.Demographics.ContractNumbers.AddRange(txtPhoneNumbers.Text.Replace(replaceString, "").Split(splitStringOn, StringSplitOptions.RemoveEmptyEntries).ToList());
            }

            if (!string.IsNullOrWhiteSpace(txtStreetAddress.Text))
            {
                searchPatientRequest.Demographics.Street = new List<string>();
                searchPatientRequest.Demographics.Street = txtStreetAddress.Text.Replace(replaceString, "").Split(splitStringOn, StringSplitOptions.RemoveEmptyEntries).ToList();

            }

            if (!string.IsNullOrWhiteSpace(txtCity.Text))
            {
                searchPatientRequest.Demographics.City = new List<string>();
                searchPatientRequest.Demographics.City = txtCity.Text.Replace(replaceString, "").Split(splitStringOn, StringSplitOptions.RemoveEmptyEntries).ToList();
            }

            if (!string.IsNullOrWhiteSpace(txtState.Text))
            {
                searchPatientRequest.Demographics.State = new List<string>();
                searchPatientRequest.Demographics.State = txtState.Text.Replace(replaceString, "").Split(splitStringOn, StringSplitOptions.RemoveEmptyEntries).ToList();
            }

            if (!string.IsNullOrWhiteSpace(txtZip.Text))
            {
                searchPatientRequest.Demographics.Zip = new List<string>();
                searchPatientRequest.Demographics.Zip = txtZip.Text.Replace(replaceString, "").Split(splitStringOn, StringSplitOptions.RemoveEmptyEntries).ToList();
            }

            if (!string.IsNullOrWhiteSpace(txtCountry.Text))
            {
                searchPatientRequest.Demographics.Country = new List<string>();
                searchPatientRequest.Demographics.Country = txtCountry.Text.Replace(replaceString, "").Split(splitStringOn, StringSplitOptions.RemoveEmptyEntries).ToList();
            }
            

            if (!string.IsNullOrWhiteSpace(txtBirthPlaceStreet.Text))
            {
                searchPatientRequest.Demographics.BirthPlaceStreet = txtBirthPlaceStreet.Text.Trim();
            }

            if (!string.IsNullOrWhiteSpace(txtBirthPlaceState.Text))
            {
                searchPatientRequest.Demographics.BirthPlaceState = txtBirthPlaceState.Text.Trim();
            }
            if (!string.IsNullOrWhiteSpace(txtBirthPlaceCity.Text))
            {
                searchPatientRequest.Demographics.BirthPlaceCity = txtBirthPlaceCity.Text.Trim();
            }

            if (!string.IsNullOrWhiteSpace(txtBirthPlaceZip.Text))
            {
                searchPatientRequest.Demographics.BirthPlaceZip = txtBirthPlaceZip.Text.Trim();
            }

            if (!string.IsNullOrWhiteSpace(txtBirthPlaceCountry.Text))
            {
                searchPatientRequest.Demographics.BirthPlaceCountry = txtBirthPlaceCountry.Text.Trim();
            }

            if (!string.IsNullOrEmpty(txtDeceasedDate.Text))
            {
                searchPatientRequest.Demographics.DeceasedDate = txtDeceasedDate.Text;
            }
    ...
    protected void CancelSearch(object sender, EventArgs e)
    {
        try
        {
            ...
            txtPatientId.Text = "";
            txtDOB.Text = "";
            txtDeceasedDate.Text = "";
            txtSSN.Text = "";

            txtMotherPrefix.Text = "";
            txtMotherGivenName.Text = "";
            txtMotherMiddleName.Text = "";
            txtMotherFamilyName.Text = "";
            ...
            txtBirthPlaceStreet.Text = "";
            txtBirthPlaceCity.Text = "";
            txtBirthPlaceState.Text = "";
            txtBirthPlaceZip.Text = "";
            txtBirthPlaceCountry.Text = "";
            txtCountry.Text = "";
