...
namespace Mobius.Client
{
    ...
    public class DocumentHelper
    {
        ...
        public DocumentHelper(bool policyDocument)
        {
        ...
        //    classificationTypeList.Add(this.SAMLAssertionHelper.GetAuthorClassCode(documentId,
        //CDAHelper.Authors.Count > 0 ? CDAHelper.Authors[0] : string.Empty));
        //    CDAHelper.Authors.Count > 0 ? CDAHelper.Authors[0].Person : string.Empty;
            ...
            {
                //Set Author Person
                authorSlots.Add(this.GetSlotType("authorPerson", "Auto Generated"));
                //Set Author Institution
                authorSlots.Add(this.GetSlotType("authorInstitution", "Auto Generated"));
                //Set Author Role
                authorSlots.Add(this.GetSlotType("authorRole", "Auto Generated"));
                //Set Author Specialty
                authorSlots.Add(this.GetSlotType("authorSpecialty", "Auto Generated"));
