...
namespace Mobius.Client
{
    public class DocumentSubmission
    {
        ...
        private DocumentHelper SAMLAssertionHelper
        {
            get;
            set;
        }

        public string HL7PatientId
        {
            get;
            set;
        }
            ...
            byte[] documentBytes, string patientId, string comment)
        {
            ...
            this.SAMLAssertionHelper = new DocumentHelper(false);
            ...
            */
            ...
            //set Author Type
            //classificationTypeList.Add(this.SAMLAssertionHelper.GetAuthorClassCode(documentId, CDAHelper.Authors[0]));
             ...
             byte[] xacmlDocumentBytes, byte[] docBytes, DateTime creationTime, DateTime ruleStartTime, DateTime ruleStopTime, string patientId)
        {
            ...
            this.SAMLAssertionHelper = new DocumentHelper(true);
            //Generate HL7 Patient Id
            this.HL7PatientId = this.SAMLAssertionHelper.GetHL7EncodePatientId(patientId, documentSubmissionComunityId);
            ...
            //SLOT_NAME_SOURCE_PATIENT_ID
            SlotTypeList.Add(this.SAMLAssertionHelper.GetSlotType(CDAConstants.SLOT_NAME_SOURCE_PATIENT_ID, this.HL7PatientId));
