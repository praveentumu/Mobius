...
{    
    ...
    public class GlobalSessions
    {
        ...
        /// <summary>
        /// This is defined for retrieving the Session value of the defined key
        /// </summary>
        ...
        /// </summary>
        /// <param name="sKey">enumSessionItem (defined in Common Class)</param>
        /// <param name="objSessionValue">object as Session Value</param>
        //public static void SessionItem(string  sKey,out object objSessionValue)
        //{
        //    SessionData oSession = new SessionData();
        //    object sValue = oSession.getItem(sKey);
        //    oSession = null;
        //    if (sValue != null)
        //        objSessionValue = sValue;
        //    else
