    ...
    a.widget("ui.dropdownchecklist", {
        ...
        _appendOption: function (g, b, h, d, n) {
            ...
            if (k != null && k != "") {
                ...
                var e = n || g.prop("disabled");
                var c = m.controlSelector.attr("tabindex");
                var l = m._createDropItem(h, c, j, k, i, f, e, d);
                b.append(l);
            }
        },
        _syncSelected: function (h) {
            var i = this, l = this.options, b = this.sourceSelect, d = this.dropWrapper;
            var c = b.get(0).options;
            var g = d.find("input");
            if (l.firstItemChecksAll == "exclusive") {
                if (h == null && a(c[0]).prop("selected")) {
                    g.prop("checked", false);
                    a(g[0]).prop("checked", true);
                } else {
                    if (h != null && h.attr("index") == 0) {
                        var e = h.prop("checked");
                        g.prop("checked", false);
                        a(g[0]).prop("checked", e);
                    } else {
                        var f = true;
                        var k = null;
                        g.each(function (m) {
                            if (m > 0) {
                                var n = a(this).prop("checked");
                                if (!n) {
                                    f = false;
                                }
                            } else {
                ...
                if (l.firstItemChecksAll) {
                    if (h == null && a(c[0]).prop("selected")) {
                        g.prop("checked", true);
                    } else {
                        if (h != null && h.attr("index") == 0) {
                            g.prop("checked", h.prop("checked"));
                        } else {
                            var f = true;
                            var k = null;
                            g.each(function (m) {
            ...
            g.each(function (n) {
                ...
                m.prop("selected", a(this).prop("checked"));
            });
            i._updateControlText();
            if (h != null) {
                h.focus();
            }
        },
        ...
        _formatText: function (b, d, e) {
            ...
            if (a.isFunction(this.options.textFormatFunction)) {
                ...
                if (d && e != null && e.prop("selected")) {
                    f = e.html();
                } else {
                    f = "";
                    b.each(function () {
                        if (a(this).prop("selected")) {
                            if (f != "") {
                                f += ", ";
                            }
        ...
        _toggleDropContainer: function (e) {
            ...
            var d = function (f) {
                if (f != null && f.dropWrapper.isOpen) {
                    ...
                    f.dropWrapper.find("input.active").prop("disabled", true);
        ...
        _setSize: function (b) {
            ...
            a(f).css('width', 'auto');
            f.find(".ui-dropdownchecklist-dropcontainer").css('max-height','180px').css('overflow-x','hidden').css('min-width','174px');
        },
        _init: function () {
            ...
            g.css("display", "none");
            c.initialMultiple = g.prop("multiple");
            c.isMultiple = c.initialMultiple;
            if (d.forceMultiple != null) {
                c.isMultiple = d.forceMultiple;
            }
            if (!c.initialMultiple && c.isMultiple) {
                g.prop("multiple", true);
            }
            c.sourceSelect = g;
        ...
        refresh: function () {
            ...
            e.children().each(function (i) {
                var j = a(this);
                var l = j.prop("disabled");
                if (j.is("option")) {
                    var k = j.prop("selected");
                    var n = a(c[f]);
                    ...
                    if (j.is("optgroup")) {
                        ...
                        j.children("option").each(function () {
                            var p = a(this);
                            var r = l || p.prop("disabled");
                            var q = p.prop("selected");
                            var s = a(c[f]);
