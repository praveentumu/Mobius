...
{
    public class AdapterPolicyEngine : IDisposable
    {
        ...
        private Demographics getPatientDemographics(CheckPolicyRequestType checkPolicyRequest)
        {
            ...
            if (checkPolicyRequest.assertion.address != null)
            {
                Address Address = new Entity.Address();
                Address.AddressLine1 = checkPolicyRequest.assertion.address.streetAddress;
                Address.Zip = checkPolicyRequest.assertion.address.zipCode;
                Address.City.CityName = checkPolicyRequest.assertion.address.city;
                Address.City.State.StateName = checkPolicyRequest.assertion.address.state;
                Address.City.State.Country.CountryName = checkPolicyRequest.assertion.address.country;
            }
