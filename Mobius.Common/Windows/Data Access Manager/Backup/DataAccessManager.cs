...
namespace FirstGenesis.Mobius.Server.DataAccessLayer
{
    public class DataAccessManager
    {
        ...
        private const string _strConnectionString = "ConnectionString";
        ...
        {
            _strSQLConn = System.Configuration.ConfigurationSettings.AppSettings[_strConnectionString].ToString();
            return _strSQLConn;
        }
    ...
    public class AdminService
    {
        ...
        public DataSet GetCurrentFacilityInfo()
        {
            DbCommand dbCommand;
            DataSet dataSet = null;
            try
            {
                dbCommand = _dataAccessManager.GetStoredProcCommand("GetCurrentFacilityInfo");
                dataSet = _dataAccessManager.ExecuteDataSet(dbCommand);
            }
            catch (Exception ex)
            {
